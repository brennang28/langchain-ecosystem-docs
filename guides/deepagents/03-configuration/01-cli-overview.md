...
<img src="https://mintcdn.com/langchain-5e9cc07a/K17j_uBSCpWoKNGK/oss/images/deepagents/deepagents-cli.png?fit=max&auto=format&n=K17j_uBSCpWoKNGK&q=85&s=65b8e32a3d973ebdf0a5bffc06fc057b" alt="Deep Agents CLI" width="1572" height="1408" data-path="oss/images/deepagents/deepagents-cli.png" />
...
* **[MCP tools](/oss/python/deepagents/cli/mcp-tools)** - load external tools from [Model Context Protocol](https://modelcontextprotocol.io/) servers.
* **[Tracing](/oss/python/deepagents/cli/overview#tracing-with-langsmith)** - trace agent operations in LangSmith for observability and debugging.
...
> 💡 **Tip**
>
> To avoid setting keys in every terminal session, add them to `~/.deepagents/.env`. See [environment variables](/oss/python/deepagents/cli/configuration#environment-variables).
...
```bash Script theme={"theme":{"light":"catppuccin-latte","dark":"catppuccin-mocha"}}
      ...
      ```bash Optional extras theme={"theme":{"light":"catppuccin-latte","dark":"catppuccin-mocha"}}
...
<details>
<summary>Interactive model selector</summary>
...
<details>
<summary>When to use global vs. project AGENTS.md</summary>
...
<details>
<summary>Install community skills</summary>
...
<details>
<summary>Skill discovery</summary>
...
<details>
<summary>Invoke a skill from the command line</summary>
...
<details>
<summary>Example: cost-efficient subagents</summary>
...
<details>
<summary>Sandbox flags and examples</summary>

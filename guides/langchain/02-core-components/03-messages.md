...
- **`tool_calls`** (`dict[] | None`): The tool calls made by the model.
...
- **`param`** (`object[]`): List of annotations for the text


        
- **`param`** (`object`): Additional provider-specific data
...
- **`param`** (`string`): Always `"reasoning"`


        
- **`param`** (`string`): The reasoning content
...
- **`param`** (`string`): Always `"image"`


        
- **`param`** (`string`): URL pointing to the image location.
...
- **`param`** (`string`): Unique identifier for this content block (either generated by the provider or by LangChain).


        
- **`param`** (`string`): Image [MIME type](https://www.iana.org/assignments/media-types/media-types.xhtml#image) (e.g., `image/jpeg`, `image/png`). Required for base64 data.
...
- **`param`** (`string`): Always `"audio"`


        
- **`param`** (`string`): URL pointing to the audio location.
...
- **`param`** (`string`): Audio [MIME type](https://www.iana.org/assignments/media-types/media-types.xhtml#audio) (e.g., `audio/mpeg`, `audio/wav`). Required for base64 data.
...
- **`param`** (`string`): Always `"video"`


        
- **`param`** (`string`): URL pointing to the video location.


        
- **`param`** (`string`): Base64-encoded video data.
...
- **`param`** (`string`): Video [MIME type](https://www.iana.org/assignments/media-types/media-types.xhtml#video) (e.g., `video/mp4`, `video/webm`). Required for base64 data.
...
- **`param`** (`string`): Always `"file"`


        
- **`param`** (`string`): URL pointing to the file location.


        
- **`param`** (`string`): Base64-encoded file data.
...
- **`param`** (`string`): File [MIME type](https://www.iana.org/assignments/media-types/media-types.xhtml) (e.g., `application/pdf`). Required for base64 data.
...
- **`param`** (`string`): Always `"text-plain"`
...
- **`param`** (`string`): [MIME type](https://www.iana.org/assignments/media-types/media-types.xhtml) of the text (e.g., `text/plain`, `text/markdown`)
...
- **`param`** (`string`): Always `"tool_call"`


        
- **`param`** (`string`): Name of the tool to call


        
- **`param`** (`object`): Arguments to pass to the tool


        
- **`param`** (`string`): Unique identifier for this tool call
...
- **`param`** (`string`): Always `"tool_call_chunk"`


        
- **`param`** (`string`): Name of the tool being called


        
- **`param`** (`string`): Partial tool arguments (may be incomplete JSON)


        
- **`param`** (`string`): Tool call identifier


        
- **`param`** (`number | string`): Position of this chunk in the stream
...
- **`param`** (`string`): Always `"invalid_tool_call"`


        
- **`param`** (`string`): Name of the tool that failed to be called
...
- **`param`** (`string`): Description of what went wrong
...
- **`param`** (`string`): Always `"server_tool_call"`


        
- **`param`** (`string`): An identifier associated with the tool call.


        
- **`param`** (`string`): The name of the tool to be called.
...
- **`param`** (`string`): Always `"server_tool_call_chunk"`
...
- **`param`** (`string`): Always `"server_tool_result"`


        
- **`param`** (`string`): Identifier of the corresponding server tool call.


        
- **`param`** (`string`): Identifier associated with the server tool result.


        
- **`param`** (`string`): Execution status of the server-side tool. `"success"` or `"error"`.


        
- **`param`**: Output of the executed tool.
...
- **`param`** (`string`): Always `"non_standard"`


      
- **`param`** (`object`): Provider-specific data structure

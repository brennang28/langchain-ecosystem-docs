...
📖 [View in docs](https://reference.langchain.com/python/langchain-classic/smith)
...
- [`arun_on_dataset()`](https://reference.langchain.com/python/langchain-classic/smith/arun_on_dataset)
- [`run_on_dataset()`](https://reference.langchain.com/python/langchain-classic/smith/run_on_dataset)

---

[View source on GitHub](https://github.com/langchain-ai/langchain/blob/65bbd47cb2721c51ef8638f9e7da35247c4bfdde/libs/langchain/langchain_classic/smith/__init__.py)